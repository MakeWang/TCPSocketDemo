 ...
 * ���������б�(���Ѷ�Ļ����ᷢ�Ͷ����)
 */
public final class PB_RS_AFQ_LIST extends Message {
  ...
  /**
   * ����������Ϣ���� //old is PB_USER ,changed by zm 2015/9/7
   */
  @ProtoField(tag = 4, label = REPEATED, messageType = PB_ADD_INFO.class)
  ...
  public PB_RS_AFQ_LIST(Long userid, Boolean succ, Boolean end, List<PB_ADD_INFO> items, Integer unread) {
    this.userid = userid;
    this.succ = succ;
    this.end = end;
  ...
  private PB_RS_AFQ_LIST(Builder builder) {
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof PB_RS_AFQ_LIST)) return false;
    PB_RS_AFQ_LIST o = (PB_RS_AFQ_LIST) other;
  ...
  public static final class Builder extends Message.Builder<PB_RS_AFQ_LIST> {
    ...
    public Builder(PB_RS_AFQ_LIST message) {
      super(message);
    ...
    @Override
    public PB_RS_AFQ_LIST build() {
      checkRequiredFields();
      return new PB_RS_AFQ_LIST(this);
    }
  }
}
